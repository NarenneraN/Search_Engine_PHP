...
echo "reached line 25.";
             ...
             if(($_FILES['file']['size'] >= $maxsize) || ($_FILES["file"]["size"] == 0)) {
                 ...
                 if(move_uploaded_file($_FILES['file']['tmp_name'],$target_file)){
                     ...
                     $acc_id=$_SESSION['id'];
                     $query = "INSERT INTO content(name,location,author_id,media_type,title,description) VALUES('".$name."','".$target_file."',$acc_id,'video','".$tit."','".$desc."')";
  ...
  <body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <h1><strong>Upload Video</strong></h1>
      ...
      <div class="form-group file-area">
        ...
        <input type="file" name="file" id="images" required="required" accept="video/mp4,video/x-m4v,video/*"/>
      ...
      <div class="form-group">
        <button type="submit" value='Upload' name='but_upload'>Upload video</button>
      </div>
